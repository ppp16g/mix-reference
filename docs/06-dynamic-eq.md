...
## Fender Studio Pro（Pro EQ3）での運用

- Sidechain を ON にし、バンドの Dynamics を ON にすると、サイドチェイン入力に反応して動作する
- トリガー側のチャンネルから **Pro EQ3 のサイドチェイン入力へセンド**する
- **トリガーはドラムバス全体ではなくキック単体から送る。** バス全体だとスネアもハットも低域を揺らす
- Thrs＝スレッショルド、Range＝最大変化量
